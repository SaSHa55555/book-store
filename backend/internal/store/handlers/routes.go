...
import (
	...
	"github.com/SaSHa55555/book-store/pkg/middleware"
...
func (h *StoreHandler) InitRoutes() *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://book-store-2-c6pm.onrender.com"},
	...
	router.OPTIONS("/*any", func(c *gin.Context) {
		c.Header("Access-Control-Allow-Origin", "https://book-store-2-c6pm.onrender.com")
